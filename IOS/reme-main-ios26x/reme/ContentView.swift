...
struct ContentView: View {
    ...
    @State private var gemini_model: String = UserDefaults(suiteName: "group.com.ereinhardt.reme")!.string(forKey: "gemini_model") ?? ""
        ...
        NavigationStack {
            List {
                ...
                Section(header: Text("Gemini Model")) {
                    ...
                    TextField("Enter Model (e.g. gemini-2.0-flash)", text: $gemini_model)
                    .background(Color.white) // Hintergrundfarbe der Section
                    .cornerRadius(5)
            ...
            .navigationTitle("re: me – Settings")
            .fileImporter(
